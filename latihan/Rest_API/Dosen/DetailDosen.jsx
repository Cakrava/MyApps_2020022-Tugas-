...
const DetailDosen = ({route}) => {
  ...
  const editdosen = () => {
    navigation.navigate('EditDosen', {
      nik_2020022: dosen.nik_2020022,
    });
  };

  const goToPageFormUpload = () => {
    navigation.navigate('FormUpload', {
      nik_2020022: nik_2020022,
      foto_2020022: dosen.foto_thumb_2020022,
      jenis: dosen.jenis_kelamin_2020022,
    });
  };
        ...
        <View style={styles.container}>
          <View style={styles.header}>
            <View style={styles.subHeader}>
              <View style={styles.headerAkhir}>
                <Text style={styles.title}> Dosen</Text>
          ...
          <View>
            <TouchableOpacity onPress={togalGantiFoto}>
              <View style={styles.foto}>
                <Avatar
                  ...
                  source={
                    dosen.foto_2020022
                      ? {uri: `${apiImage}${dosen.foto_thumb_2020022}`}
                      : dosen.jenis_kelamin_2020022 === 'L'
                      ? avatarLaki
                      : dosen.jenis_kelamin_2020022 === 'P'
                      ? avatarPerempuan
                      : defaultAvatar
                  }
            ...
            <TouchableOpacity
              ...
              <Icon name="camera-outline" size={20} color="tomato" />
            </TouchableOpacity>
          </View>
          ...
          <View style={{width: '100%', marginTop: 20}}>
            <View style={{flexDirection: 'row'}}>
              ...
              <Text style={styles.detail}>: {dosen.nik_2020022}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              <Text style={[styles.detail, {width: 120}]}>Nama Lengkap</Text>
              <Text style={styles.detail}>: {dosen.nama_lengkap_2020022}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              <Text style={[styles.detail, {width: 120}]}>Alamat</Text>
              <Text style={styles.detail}>: {dosen.alamat_2020022}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <Text style={styles.detail}>: {dosen.tanggal_lahir_2020022}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
              <Text style={[styles.detail, {width: 120}]}>Tempat Lahir</Text>
              <Text style={styles.detail}>: {dosen.tempat_lahir_2020022}</Text>
            </View>
            <View style={{flexDirection: 'row'}}>
          ...
          <Text style={[styles.detail, {fontSize: 15}]}>
            Dosen Aktif 2024 Matakuliah {dosen.matakuliah_2020022}
          </Text>
        </View>
      )}

      <TouchableOpacity style={styles.fab} onPress={() => editdosen()}>
      ...
      <Animated.View
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Icon name="camera" size={30} color="tomato" />
          </TouchableOpacity>
          <TouchableOpacity
            onPress={searchImage}
            style={{
          ...
          <TouchableOpacity
            ...
            style={{
              ...
              width: 50,
              height: 50,
              borderColor: isUploadButtonDisable ? 'white' : 'tomato',
              borderWidth: 1,
              backgroundColor: 'white',
              justifyContent: 'center',
              alignItems: 'center',
            ...
            <Icon
              ...
              size={30}
              color={isUploadButtonDisable ? 'white' : 'tomato'}
            />
          </TouchableOpacity>
        </View>
      </Animated.View>
