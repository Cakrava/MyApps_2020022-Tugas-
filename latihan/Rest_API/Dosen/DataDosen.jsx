...
export default function DataDosen() {
  ...
  const renderItemDosen = ({item, index}) => {
    ...
    const renderRightActions = () => {
      const handleDelete = nik_2020022 => {
        Alert.alert(
          'Konfirmasi',
      ...
      return (
        <View
          ...
          <TouchableOpacity
            onPress={() => handleDelete(item.nik_2020022)}
            style={{
    ...
    const bukadetail = item => {
      navigation.navigate('Detail', {
        nik_2020022: item.nik_2020022,
      });
    };
    const editdosen = item => {
                ...
                <View
                  ...
                  <View>
                    ...
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text style={styles.idCode}> {item.nik_2020022}</Text>
                    </View>
                  </View>
                </View>
    ...
    <ImageBackground source={require('../Src/latar.jpg')} style={{flex: 1}}>
      <GestureHandlerRootView>
        <View style={styles.bar}>
          ...
          <Text style={styles.note}>Data dosen kampus STMIK-AMIK Jayanusa</Text>
          <View style={{flexDirection: 'row'}}>
        ...
        <View style={{marginLeft: 10, marginRight: 10}}>
          ...
          <FlatList
            ...
            keyExtractor={item => item.nik_2020022}
